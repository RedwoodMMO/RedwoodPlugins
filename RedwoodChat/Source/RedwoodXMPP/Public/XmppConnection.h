...
public:
  FXmppServer() :
    ServerPort(5222), bUseSSL(true), bUsePlainTextAuth(false),
    PingInterval(60.0f), PingTimeout(30.0f), MaxPingRetries(1),
    bPrivateChatFriendsOnly(false), bResetPingTimeoutOnReceiveStanza(true) {}
...
public:
  explicit FXmppUserJid(
    ...
    Id(MoveTemp(InId)),
    Domain(MoveTemp(InDomain)), Resource(MoveTemp(InResource)) {}
  ...
  /**
	 ...
	 */
  static REDWOODXMPP_API FXmppUserJid FromFullJid(const FString &JidString);
  ...
  /**
	 ...
	 */
  static REDWOODXMPP_API bool ParseResource(
  ...
  static REDWOODXMPP_API FString CreateResource(
    const FString &AppId, const FString &Platform, const FString &PlatformUserId
  );
  ...
  /**
	 ...
	 */
  bool ParseResource(
    FString &OutAppId, FString &OutPlatform, FString &OutPlatformUserId
  ) const {
  ...
  /**
	 ...
	 */
  static REDWOODXMPP_API FString ParseMucUserResource(const FString &InResource
  );
  ...
  REDWOODXMPP_API FString ToDebugString() const;
};
...
typedef TSharedPtr<IXmppMultiUserChat, ESPMode::ThreadSafe>
...
public:
  ...
  using FOnXmppLogingChanged UE_DEPRECATED(
    4.23,
    "Please update usages of 'FOnXmppLogingChanged' to 'FOnXmppLoginChanged'"
  ) = FOnXmppLoginChanged;
  /**
  ...
  DECLARE_MULTICAST_DELEGATE_OneParam(
    FOnXmppStanzaReceived, const IXmppStanza & /* Stanza */
  );
  ...
  /**
	...
	*/
  DECLARE_MULTICAST_DELEGATE_OneParam(
    FOnXmppStanzaSent, const IXmppStanza & /* Stanza */
  );
